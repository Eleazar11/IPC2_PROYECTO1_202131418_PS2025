<%-- 
    ...
    Created on : 12/03/2025, 16:20:55
    Author     : eleaz
--%>
...
<body onload="loadPage('home')">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="${pageContext.servletContext.contextPath}/ObtenerUsuariosServlet">Ver Lista de Usuarios</a></li>
                            <li><a class="dropdown-item" href="${pageContext.servletContext.contextPath}/EditarUsuarioServlet">Modificar Usuario</a></li>
                            <li><a class="dropdown-item" href="${pageContext.servletContext.contextPath}/EliminarUsuarioServlet">Eliminar Usuario</a></li>
                        </ul>
                    </li>
    ...
    <main id="content" class="container mt-4">
        <section class="mt-5 content container">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#editarUsuarioModal"
