 ...
 * @author eleaz
 */
@WebServlet(name = "ObtenerComponentesEliminarServlet", urlPatterns = {"/ObtenerComponentesEliminarServlet"})
@MultipartConfig(fileSizeThreshold = 1024 * 1024, maxFileSize = 1024 * 1024 * 5, maxRequestSize = 1024 * 1024 * 5 * 5)
public class ObtenerComponentesEliminarServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            request.getRequestDispatcher("../../areaEnsamblaje/eliminarComponente.jsp").forward(request, response);
        } catch (Exception e) {
            e.printStackTrace();
