 ...
 * @author eleaz
 */
@WebServlet(name = "ObtenerModelosComputadoraModificarServlet", urlPatterns = {"/ObtenerModelosComputadoraModificarServlet"})
@MultipartConfig(fileSizeThreshold = 1024 * 1024, maxFileSize = 1024 * 1024 * 5, maxRequestSize = 1024 * 1024 * 5 * 5)
public class ObtenerModelosComputadoraModificarServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            request.getRequestDispatcher("../../areaAdministracion/editarModelosComputadora.jsp").forward(request, response);
