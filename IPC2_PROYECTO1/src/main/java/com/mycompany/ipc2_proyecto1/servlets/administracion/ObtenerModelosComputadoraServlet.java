 ...
 * @author eleaz
 */
@WebServlet(name = "ObtenerModelosComputadoraServlet", urlPatterns = {"/ObtenerModelosComputadoraServlet"})
@MultipartConfig(fileSizeThreshold = 1024 * 1024, maxFileSize = 1024 * 1024 * 5, maxRequestSize = 1024 * 1024 * 5 * 5)
public class ObtenerModelosComputadoraServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            request.getRequestDispatcher("../../areaAdministracion/listadoModelosComputadora.jsp").forward(request, response);
